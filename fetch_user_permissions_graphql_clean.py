...
class GitHubGraphQLPermissionsFetcher:
    ...
    def fetch_teams_for_repo(self, repo_name: str, repo_full_name: str) -> List[Dict[str, Any]]:
        """Fetch teams with access to a specific repository using direct REST API calls with REL_TOKEN.
        
        This approach bypasses GitHub CLI and uses direct HTTP requests with proper authentication.
        """
        print(f"    🔍 Querying teams via REST API for {repo_name}...")
        all_teams = []
        
        # Get the token being used by the main script
        ...
        headers = {
            ...
            'User-Agent': 'GitHub-Permissions-Fetcher/1.0'
        }
